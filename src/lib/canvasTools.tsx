...
export const getToolCursor = (tool: Tool): string => {
  const cursors: Record<Tool, string> = {
    ...
    circle: cursorSvg('<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><circle cx="16" cy="16" r="10" fill="none" stroke="#111827" stroke-width="3"/><path d="M16 4v4M16 24v4M4 16h4M24 16h4" stroke="#10b981" stroke-width="3" stroke-linecap="round"/></svg>', 16, 16),
    ...
    text: cursorSvg('<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 32 32"><path d="M8 8h16M16 8v16" fill="none" stroke="#10b981" stroke-width="4" stroke-linecap="round"/></svg>', 9, 5),
