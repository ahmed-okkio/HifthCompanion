  ...
  return (
    <div className="flex flex-col items-center min-h-screen"
      ...
      <header className="glass sticky top-0 z-50 w-full"
        ...
        <div className="mx-auto flex items-center justify-between px-4 py-2.5 max-w-4xl">
      ...
      <main className="relative w-full max-w-2xl px-3 py-5 flex-grow sm:px-4 animate-fade-in">
        {/* Read-only badge */}
        <div className="mb-3 flex items-center gap-2 px-3 py-2 rounded-lg w-fit"
             style={{
